...
import com.pdextended.noosa.particles.BitmaskEmitter;
...
import com.pdextended.pixeldungeonextended.effects.BannerSprites.Type;
...
import com.pdextended.pixeldungeonextended.ui.RedButton;
import com.pdextended.pixeldungeonextended.utils.Utils;
import com.pdextended.pixeldungeonextended.windows.WndChallenges;
import com.pdextended.pixeldungeonextended.windows.WndClass;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[PixelDungeonExtended.lastClass()] );
	...
	private void startNewGame() {
		...
		if (PixelDungeonExtended.intro()) {
			PixelDungeonExtended.intro( false );
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( PixelDungeonExtended.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add( new WndChallenges( PixelDungeonExtended.challenges(), true ) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( PixelDungeonExtended.challenges() > 0 ?
