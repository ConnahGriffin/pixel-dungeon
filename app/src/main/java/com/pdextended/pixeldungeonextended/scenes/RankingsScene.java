...
import com.pdextended.pixeldungeonextended.Rankings;
...
import com.pdextended.pixeldungeonextended.windows.WndError;
import com.pdextended.pixeldungeonextended.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			float rowHeight = PixelDungeonExtended.landscape() ? ROW_HEIGHT_L : ROW_HEIGHT_P;
