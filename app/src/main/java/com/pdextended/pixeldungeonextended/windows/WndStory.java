...
public class WndStory extends Window {
	...
	public static final int ID_COLLEGE		= 5;
	...
	static {
		...
		CHAPTERS.put( ID_COLLEGE,
		"A prison to many, a lifeline to others. It had many name, some far too PG to list here. " +
		"It however had a well known name, a name given to it by those who built/owns/runs the place...\n"+
		"they called it, \"The Great College of Waalzi\". Each being that frequent the place still roams about, " +
		"happy as can be. Granted, they don't have a brain to work with anymore.");
	}
