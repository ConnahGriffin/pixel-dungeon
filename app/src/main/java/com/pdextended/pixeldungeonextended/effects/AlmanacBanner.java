...
public class AlmanacBanner extends Image {
	...
	private static AlmanacBanner current;

	private AlmanacBanner(int index ) {
		
		super( Assets.ALMANAC );
	...
	public static AlmanacBanner show(int image ) {
		...
		return (current = new AlmanacBanner( image ));
	}
